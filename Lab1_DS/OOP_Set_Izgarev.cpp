...
int main() {
	...
	SetList* set_a = new SetList(SetList::random(6,9), 10, 99, 'A');
	SetList* set_b = new SetList(SetList::random(6, 9), 10, 99, 'B');
	cout << "F5. Множество А: " << set_a->ToString(' ') << endl;
	cout << "F5. Множество В: " << set_b->ToString(' ') << endl;
	cout << "F6. Мощность А: " << set_a->PowerSetList() << endl;
	cout << "F6. Мощность В: " << set_b->PowerSetList() << endl;
